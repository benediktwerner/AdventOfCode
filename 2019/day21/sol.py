...
class VM:
    ...
    def run(self, *inputs, out=None, ascii=False):
        for inp in inputs:
    ...
    def out(self, n=None, ascii=False):
        ...
        return "".join(map(to_char, outs)) if ascii else outs
...
with open(path.join(path.dirname(__file__), "input.txt")) as f:
    ...
    print("Part 1:", VM(code).run(CODE_1)[-1])
    print("Part 2:", VM(code).run(CODE_2)[-1])
